...
# Source files
SRC_BLACKBOARD = $(WORKSPACE_FOLDER)/src/blackBoard.cpp $(WORKSPACE_FOLDER)/src/obst_publisher.cpp $(WORKSPACE_FOLDER)/src/obst_subscriber.cpp $(WORKSPACE_FOLDER)/src/targ_publisher.cpp $(WORKSPACE_FOLDER)/src/targ_subscriber.cpp $(WORKSPACE_FOLDER)/src/auxfunc.c $(WORKSPACE_FOLDER)/src/Generated/ObstaclesPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/ObstaclesTypeObjectSupport.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsTypeObjectSupport.cxx

SRC_TARGET = $(WORKSPACE_FOLDER)/src/target.cpp $(WORKSPACE_FOLDER)/src/obst_publisher.cpp $(WORKSPACE_FOLDER)/src/obst_subscriber.cpp $(WORKSPACE_FOLDER)/src/targ_publisher.cpp $(WORKSPACE_FOLDER)/src/targ_subscriber.cpp $(WORKSPACE_FOLDER)/src/auxfunc.c $(WORKSPACE_FOLDER)/src/Generated/ObstaclesPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/ObstaclesTypeObjectSupport.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsTypeObjectSupport.cxx

SRC_OBSTACLE = $(WORKSPACE_FOLDER)/src/obstacle.cpp $(WORKSPACE_FOLDER)/src/obst_publisher.cpp $(WORKSPACE_FOLDER)/src/obst_subscriber.cpp $(WORKSPACE_FOLDER)/src/targ_publisher.cpp $(WORKSPACE_FOLDER)/src/targ_subscriber.cpp $(WORKSPACE_FOLDER)/src/auxfunc.c $(WORKSPACE_FOLDER)/src/Generated/ObstaclesPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/ObstaclesTypeObjectSupport.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsPubSubTypes.cxx $(WORKSPACE_FOLDER)/src/Generated/TargetsTypeObjectSupport.cxx
